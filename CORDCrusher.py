...
parser.add_argument("--output", dest="output", default = 'COVID19',help="Filebase for output files", metavar="output")
...
if "KeywordRanking" in args.mode:
